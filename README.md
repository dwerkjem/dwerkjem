...
%% Nested subgraphs force horizontal grouping while preserving internal flows.
%% Added themeVariables to turn connector lines + arrows green.
%%{init: {'flowchart': {'nodeSpacing': 28, 'rankSpacing': 55, 'diagramPadding': 8, 'useMaxWidth': true}, 'themeVariables': {'lineColor': '#00aa35', 'arrowheadColor': '#00aa35', 'primaryBorderColor': '#00aa35', 'secondaryBorderColor': '#00aa35', 'tertiaryBorderColor': '#00aa35', 'edgeLabelBackground': '#e6ffe9'}}}%%
flowchart TB
  %% ---------- ROW 1 ----------
  subgraph ROW1[Row 1]
    direction LR
  ...
  DP3[Requirements Functional / Non-Functional]
  ...
  subgraph DESIGN[Design and Architecture]
      ...
      DA2[ADR Records]
      DA3[Data Model / Schema]
      DA4[API & Contracts]
  DA5[Security and Privacy]
      DA6{Need PoC?}
      DA7[Spike / PoC]
      DP6 --> DA1 --> DA2 --> DA3 --> DA4 --> DA5 --> DA6
      DA6 -- Yes --> DA7 --> FEASIBLE
      DA6 -- No  --> FEASIBLE
    end
  ...
  subgraph IMPLEMENT[Implementation]
      ...
      IMPL5[Implement Code & Tests]
      IMPL6[Local Quality Checks]
      IMPL7[[Open Pull Request]]
      IMPL8[Peer Code Review]
      IMPL9[[Merge to main]]
      FEASIBLE --> IMPL1 --> IMPL2 --> IMPL3 --> IMPL4 --> IMPL5 --> IMPL6 --> IMPL7 --> IMPL8
      REVIEW{Approved?}
      IMPL8 --> REVIEW
      REVIEW -- No  --> IMPL5
      REVIEW -- Yes --> IMPL9
  ...
  subgraph RELEASE[Release and Deployment]
      ...
      REL2[DB Migration & Rollback Plan]
  ...
  REL6[Security DAST / Secrets / SBOM]
      ...
      GO_NO_GO -- Go --> REL8
  REL8[Prod Deploy Canary / Blue-Green]
  ...
  OP7[Usage Analytics and Experiments]
